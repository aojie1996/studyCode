...
public class OmOrderHeaders extends BaseDTO {
     ...
     @Children
     @Transient
     private List<OmOrderLines> omOrderLinesList;//行表中的数据

    @Transient
    private String itemCode;//物料编码

    @Transient
    private double totalPrice;//计算总价

    @Transient
    private Long inventoryItemId;//得到其对应的物料ID

    public Long getInvetoryItemId() {
        return inventoryItemId;
    }

    public void setInvetoryItemId(Long inventoryItemId) {
